...
import { Mail, Lock, ArrowLeft, Loader2, Package } from 'lucide-react';
import { User } from '../types';

interface SignInProps {
  onSignIn: (user: User) => void;
  onNavigate: (view: 'HOME' | 'SIGN_UP') => void;
}
      ...
      <div className="hidden lg:flex w-1/2 bg-primary relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-lg text-slate-300 leading-relaxed">
            Log in to access your personalized shopping experience, track orders, and chat with Lumi, your AI assistant.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-sm text-accent hover:text-blue-600 font-medium">Forgot password?</a>
              </div>
              <div className="relative">
